...
from yousi.helpers import ajax_required
from yousi.qa.models import Question, Answer
from yousi.qa.forms import QuestionForm
# from yousi.notifications.views import notification_handler
...
class AnswersListView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, *args, **kwargs):
        context = super(AnswersListView, self).get_context_data(*args, **kwargs)
        context["popular_tags"] = Question.objects.get_counted_tags()  # 页面的标签功能
        context["active"] = "all"
        return context
